...
data:extend(
{
    ...
    create_procedural_science_recipe("epilson",{r = 37,  g = 18, b = 230, a = 1},"e",ingredients_e), --rgb(37, 42, 230)
    ...
    create_procedural_crystal_recipe("epilson",{r = 37,  g = 18, b = 230, a = 1},"e"), --rgb(37, 42, 230)
